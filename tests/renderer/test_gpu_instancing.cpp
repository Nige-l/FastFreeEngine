...
TEST_CASE("BuiltinShader: COUNT is 21 (includes instanced + post-process + terrain + water shaders)", "[renderer][instancing]") {
    CHECK(static_cast<u32>(BuiltinShader::COUNT) == 21);
}
