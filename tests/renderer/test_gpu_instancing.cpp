...
TEST_CASE("BuiltinShader: COUNT is 22 (includes instanced + post-process + terrain + water + vegetation shaders)", "[renderer][instancing]") {
    CHECK(static_cast<u32>(BuiltinShader::COUNT) == 22);
}
