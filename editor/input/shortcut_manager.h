...
// Keyboard shortcut definition. Key codes use ImGuiKey enum values
// (e.g. ImGuiKey_Z, ImGuiKey_S, ImGuiKey_Delete).
// ImGui 1.91.5+ dropped support for legacy integer key indices (GLFW_KEY_*).
struct Shortcut {
...
public:
    ...
    inline void registerDefaults() {
        addBinding("undo",             ImGuiKey_Z,      /*ctrl=*/true,  /*shift=*/false, /*alt=*/false);
        addBinding("redo",             ImGuiKey_Z,      /*ctrl=*/true,  /*shift=*/true,  /*alt=*/false);
        addBinding("save",             ImGuiKey_S,      /*ctrl=*/true,  /*shift=*/false, /*alt=*/false);
        addBinding("delete_entity",    ImGuiKey_Delete, /*ctrl=*/false, /*shift=*/false, /*alt=*/false);
        addBinding("gizmo_translate",  ImGuiKey_G,      /*ctrl=*/false, /*shift=*/false, /*alt=*/false);
        addBinding("gizmo_rotate",     ImGuiKey_R,      /*ctrl=*/false, /*shift=*/false, /*alt=*/false);
        addBinding("gizmo_scale",      ImGuiKey_S,      /*ctrl=*/false, /*shift=*/false, /*alt=*/false);
    }

    // Register a custom shortcut binding.
    inline void addBinding(const char* action, const ImGuiKey key,
